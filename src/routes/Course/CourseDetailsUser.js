    ...
    <div>
        ...
        <div className='course-course-deatils-accordion'>
          ...
          <div className='course-course-deatils-accordion-right'>
            ...
            <div className="course-details-user-container course-details-centered">
              <secondRowElement1 className="second-row-element-1 text-xl course-details-centered">
                  {t("Course Content")}
              </secondRowElement1>
              <secondRowElement2 
              className="second-row-element-2 text-xl course--details-centered"
              >
                  {t("Exam")}

              </secondRowElement2>
              
              <secondRowElement3 className="second-row-element-3 text-xl course--details-centered">
                  {t("Discussion")}
              </secondRowElement3>
              
              <secondRowElement4 className="second-row-element-4 text-xl course--details-centered">
                  {t("Comment")}
              </secondRowElement4>
            </div>
